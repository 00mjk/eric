...
# Form implementation generated from reading ui file './SqlBrowser/SqlConnectionDialog.ui'
#
...
class Ui_SqlConnectionDialog(object):
    def setupUi(self, SqlConnectionDialog):
        ...
        SqlConnectionDialog.resize(400, 265)
        self.verticalLayout = QtWidgets.QVBoxLayout(SqlConnectionDialog)
        ...
        self.databaseEdit = QtWidgets.QLineEdit(SqlConnectionDialog)
        ...
        self.databaseFileButton = QtWidgets.QToolButton(SqlConnectionDialog)
        self.databaseFileButton.setObjectName("databaseFileButton")
    ...
    def retranslateUi(self, SqlConnectionDialog):
        ...
        self.databaseEdit.setToolTip(_translate("SqlConnectionDialog", "Enter the database name"))
        ...
        self.databaseFileButton.setToolTip(_translate("SqlConnectionDialog", "Press to select a database file"))
