...
# Form implementation generated from reading ui file './Plugins/VcsPlugins/vcsMercurial/HgLogBrowserDialog.ui'
#
...
class Ui_HgLogBrowserDialog(object):
    def setupUi(self, HgLogBrowserDialog):
        ...
        spacerItem1 = QtWidgets.QSpacerItem(38, 29, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        HgLogBrowserDialog.setTabOrder(self.diffP2Button, self.diffRevisionsButton)
        HgLogBrowserDialog.setTabOrder(self.diffRevisionsButton, self.sbsCheckBox)
    ...
    def retranslateUi(self, HgLogBrowserDialog):
        ...
        self.fieldCombo.setItemText(0, _translate("HgLogBrowserDialog", "Revision"))
        self.fieldCombo.setItemText(1, _translate("HgLogBrowserDialog", "Author"))
        self.fieldCombo.setItemText(2, _translate("HgLogBrowserDialog", "Message"))
        self.rxEdit.setToolTip(_translate("HgLogBrowserDialog", "Enter the regular expression to filter on"))
        ...
        self.diffP1Button.setToolTip(_translate("HgLogBrowserDialog", "Press to generate a diff to the first parent revision"))
        self.diffP1Button.setText(_translate("HgLogBrowserDialog", "Diff to Parent &1"))
        self.diffP2Button.setToolTip(_translate("HgLogBrowserDialog", "Press to generate a diff to the second parent revision"))
        self.diffP2Button.setText(_translate("HgLogBrowserDialog", "Diff to Parent &2"))
        self.diffRevisionsButton.setToolTip(_translate("HgLogBrowserDialog", "Press to compare two revisions"))
        self.diffRevisionsButton.setText(_translate("HgLogBrowserDialog", "&Compare Revisions"))
        self.sbsCheckBox.setToolTip(_translate("HgLogBrowserDialog", "Select to show differences side-by-side"))
        self.sbsCheckBox.setText(_translate("HgLogBrowserDialog", "Show differences side-by-side"))
