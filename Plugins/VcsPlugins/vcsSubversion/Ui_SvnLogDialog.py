...
# Form implementation generated from reading ui file './Plugins/VcsPlugins/vcsSubversion/SvnLogDialog.ui'
#
...
class Ui_SvnLogDialog(object):
    def setupUi(self, SvnLogDialog):
        ...
        self.inputGroup = QtWidgets.QGroupBox(SvnLogDialog)
        ...
        self.buttonBox.rejected.connect(SvnLogDialog.close)
    ...
    def retranslateUi(self, SvnLogDialog):
        ...
        self.inputGroup.setTitle(_translate("SvnLogDialog", "Input"))
        self.sendButton.setToolTip(_translate("SvnLogDialog", "Press to send the input to the subversion process"))
        self.sendButton.setText(_translate("SvnLogDialog", "&Send"))
        self.sendButton.setShortcut(_translate("SvnLogDialog", "Alt+S"))
        self.input.setToolTip(_translate("SvnLogDialog", "Enter data to be sent to the subversion process"))
        self.passwordCheckBox.setToolTip(_translate("SvnLogDialog", "Select to switch the input field to password mode"))
        self.passwordCheckBox.setText(_translate("SvnLogDialog", "&Password Mode"))
        self.passwordCheckBox.setShortcut(_translate("SvnLogDialog", "Alt+P"))
