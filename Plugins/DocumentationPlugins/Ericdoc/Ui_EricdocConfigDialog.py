...
# Form implementation generated from reading ui file './Plugins/DocumentationPlugins/Ericdoc/EricdocConfigDialog.ui'
#
...
class Ui_EricdocConfigDialog(object):
    def setupUi(self, EricdocConfigDialog):
        ...
        self.vboxlayout1 = QtWidgets.QVBoxLayout(self.generalTab)
        ...
        self.outputDirEdit = QtWidgets.QLineEdit(self.generalTab)
        self.outputDirEdit.setObjectName("outputDirEdit")
        self.hboxlayout.addWidget(self.outputDirEdit)
        self.outputDirButton = QtWidgets.QToolButton(self.generalTab)
        ...
        self.vboxlayout2 = QtWidgets.QVBoxLayout(self.styleTab)
        self.vboxlayout2.setObjectName("vboxlayout2")
        self.groupBox_3 = QtWidgets.QGroupBox(self.styleTab)
        self.groupBox_3.setObjectName("groupBox_3")
        self.hboxlayout5 = QtWidgets.QHBoxLayout(self.groupBox_3)
        self.hboxlayout5.setObjectName("hboxlayout5")
        self.cssEdit = QtWidgets.QLineEdit(self.groupBox_3)
        self.cssEdit.setObjectName("cssEdit")
        self.hboxlayout5.addWidget(self.cssEdit)
        self.cssButton = QtWidgets.QToolButton(self.groupBox_3)
        ...
        self.qtHelpDirEdit = QtWidgets.QLineEdit(self.qtHelpGroup)
        self.qtHelpDirEdit.setObjectName("qtHelpDirEdit")
        self.horizontalLayout.addWidget(self.qtHelpDirEdit)
        self.qtHelpDirButton = QtWidgets.QToolButton(self.qtHelpGroup)
        self.qtHelpDirButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.qtHelpDirButton.setObjectName("qtHelpDirButton")
    ...
    def retranslateUi(self, EricdocConfigDialog):
        ...
        self.outputDirEdit.setToolTip(_translate("EricdocConfigDialog", "Enter an output directory"))
        self.outputDirButton.setToolTip(_translate("EricdocConfigDialog", "Press to open a directory selection dialog"))
        ...
        self.ignoreDirEdit.setToolTip(_translate("EricdocConfigDialog", "Enter a directory basename to be ignored"))
        ...
        self.ignoreDirButton.setToolTip(_translate("EricdocConfigDialog", "Press to open a directory selection dialog"))
        ...
        self.cssEdit.setToolTip(_translate("EricdocConfigDialog", "Enter the filename of a CSS style sheet. Leave empty to use the colours defined below."))
        self.cssButton.setToolTip(_translate("EricdocConfigDialog", "Press to open a file selection dialog"))
        ...
        self.qtHelpDirEdit.setToolTip(_translate("EricdocConfigDialog", "Enter an output directory"))
        self.qtHelpDirButton.setToolTip(_translate("EricdocConfigDialog", "Press to open a directory selection dialog"))
