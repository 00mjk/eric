...
# Form implementation generated from reading ui file './Helpviewer/Bookmarks/BookmarksImportDialog.ui'
#
...
class Ui_BookmarksImportDialog(object):
    def setupUi(self, BookmarksImportDialog):
        ...
        self.gridLayout = QtWidgets.QGridLayout(self.filePage)
        ...
        self.gridLayout.addWidget(self.importingFromLabel, 0, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.fileLabel1, 2, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.standardDirLabel, 3, 0, 1, 3)
        self.fileLabel2 = QtWidgets.QLabel(self.filePage)
        self.fileLabel2.setObjectName("fileLabel2")
        self.gridLayout.addWidget(self.fileLabel2, 4, 0, 1, 3)
        ...
        self.fileEdit = QtWidgets.QLineEdit(self.filePage)
        self.fileEdit.setEnabled(False)
        self.fileEdit.setObjectName("fileEdit")
        self.horizontalLayout_3.addWidget(self.fileEdit)
        self.chooseButton = QtWidgets.QToolButton(self.filePage)
        self.chooseButton.setObjectName("chooseButton")
        self.horizontalLayout_3.addWidget(self.chooseButton)
        ...
        self.verticalLayout_2.addWidget(self.pagesWidget)
        ...
        BookmarksImportDialog.setTabOrder(self.cancelButton, self.fileEdit)
        BookmarksImportDialog.setTabOrder(self.fileEdit, self.chooseButton)
    ...
    def retranslateUi(self, BookmarksImportDialog):
        ...
        self.fileEdit.setToolTip(_translate("BookmarksImportDialog", "Shows the name of the bookmarks file or directory"))
