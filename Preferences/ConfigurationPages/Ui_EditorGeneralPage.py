...
# Form implementation generated from reading ui file './Preferences/ConfigurationPages/EditorGeneralPage.ui'
#
...
class Ui_EditorGeneralPage(object):
    def setupUi(self, EditorGeneralPage):
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(EditorGeneralPage)
        ...
        self.vboxlayout = QtWidgets.QVBoxLayout(self.groupBox_5)
        ...
        self.indentguidesCheckBox = QtWidgets.QCheckBox(self.groupBox_5)
    ...
    def retranslateUi(self, EditorGeneralPage):
        ...
        self.indentguidesCheckBox.setToolTip(_translate("EditorGeneralPage", "Select whether indentation guides should be shown."))
        self.indentguidesCheckBox.setText(_translate("EditorGeneralPage", "Show Indentation Guides"))
