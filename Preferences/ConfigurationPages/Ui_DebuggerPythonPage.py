...
# Form implementation generated from reading ui file './Preferences/ConfigurationPages/DebuggerPythonPage.ui'
#
...
class Ui_DebuggerPythonPage(object):
    ...
    def retranslateUi(self, DebuggerPythonPage):
        ...
        self.interpreterEdit.setToolTip(_translate("DebuggerPythonPage", "Enter the path of the Python interpreter to be used by the debug client."))
        self.interpreterButton.setToolTip(_translate("DebuggerPythonPage", "Press to select the Python interpreter via a file selection dialog"))
        self.groupBox_2.setTitle(_translate("DebuggerPythonPage", "Debug Client Type"))
        self.debugClientEdit.setToolTip(_translate("DebuggerPythonPage", "Enter the path of the Debug Client to be used.  Leave empty to use the default."))
        self.debugClientButton.setToolTip(_translate("DebuggerPythonPage", "Press to select the Debug Client via a file selection dialog"))
        ...
        self.threadedButton.setToolTip(_translate("DebuggerPythonPage", "Select the multi threaded debug client"))
        self.threadedButton.setText(_translate("DebuggerPythonPage", "Multi Threaded"))
