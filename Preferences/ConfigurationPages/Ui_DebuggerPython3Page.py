...
# Form implementation generated from reading ui file './Preferences/ConfigurationPages/DebuggerPython3Page.ui'
#
...
class Ui_DebuggerPython3Page(object):
    def setupUi(self, DebuggerPython3Page):
        ...
        self.interpreterEdit = QtWidgets.QLineEdit(self.groupBox)
        self.interpreterEdit.setObjectName("interpreterEdit")
        self.gridLayout.addWidget(self.interpreterEdit, 0, 0, 1, 1)
        self.interpreterButton = QtWidgets.QToolButton(self.groupBox)
        ...
        self.debugClientEdit = QtWidgets.QLineEdit(self.groupBox_2)
        ...
        self.debugClientButton = QtWidgets.QToolButton(self.groupBox_2)
        ...
        self.threadedButton = QtWidgets.QRadioButton(self.groupBox_2)
        self.threadedButton.setObjectName("threadedButton")
        self.gridlayout.addWidget(self.threadedButton, 0, 1, 1, 1)
        ...
        self.customButton.toggled['bool'].connect(self.debugClientEdit.setEnabled)
    ...
    def retranslateUi(self, DebuggerPython3Page):
        ...
        self.interpreterEdit.setToolTip(_translate("DebuggerPython3Page", "Enter the path of the Python3 interpreter to be used by the debug client. Leave empty to use the default."))
        self.interpreterButton.setToolTip(_translate("DebuggerPython3Page", "Press to select the Python3 interpreter via a file selection dialog"))
        self.groupBox_2.setTitle(_translate("DebuggerPython3Page", "Debug Client Type"))
        self.debugClientEdit.setToolTip(_translate("DebuggerPython3Page", "Enter the path of the Debug Client to be used.  Leave empty to use the default."))
        self.debugClientButton.setToolTip(_translate("DebuggerPython3Page", "Press to select the Debug Client via a file selection dialog"))
        ...
        self.threadedButton.setToolTip(_translate("DebuggerPython3Page", "Select the multi threaded debug client"))
        self.threadedButton.setText(_translate("DebuggerPython3Page", "Multi Threaded"))
