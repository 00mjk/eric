...
# Form implementation generated from reading ui file './Preferences/ConfigurationPages/EmailPage.ui'
#
...
class Ui_EmailPage(object):
    def setupUi(self, EmailPage):
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(EmailPage)
        ...
        self.useTlsCheckBox = QtWidgets.QCheckBox(EmailPage)
        self.useTlsCheckBox.setObjectName("useTlsCheckBox")
        self.verticalLayout.addWidget(self.useTlsCheckBox)
        self.mailAuthenticationCheckBox = QtWidgets.QCheckBox(EmailPage)
        ...
        self.textLabel1_15 = QtWidgets.QLabel(EmailPage)
        ...
        self.mailUserEdit = QtWidgets.QLineEdit(EmailPage)
        ...
        self.textLabel2_7 = QtWidgets.QLabel(EmailPage)
        ...
        self.mailPasswordEdit = QtWidgets.QLineEdit(EmailPage)
        ...
        self.testButton = QtWidgets.QPushButton(EmailPage)
        ...
        self.mailAuthenticationCheckBox.toggled['bool'].connect(self.textLabel1_15.setEnabled)
        self.mailAuthenticationCheckBox.toggled['bool'].connect(self.textLabel2_7.setEnabled)
        self.mailAuthenticationCheckBox.toggled['bool'].connect(self.mailUserEdit.setEnabled)
        self.mailAuthenticationCheckBox.toggled['bool'].connect(self.mailPasswordEdit.setEnabled)
    ...
    def retranslateUi(self, EmailPage):
        ...
        self.label.setText(_translate("EmailPage", "Outgoing mail server port:"))
        ...
        self.useTlsCheckBox.setToolTip(_translate("EmailPage", "Select to use TLS"))
        self.useTlsCheckBox.setText(_translate("EmailPage", "Use TLS"))
        self.mailAuthenticationCheckBox.setToolTip(_translate("EmailPage", "Select to authenticatate against the mail server"))
        self.mailAuthenticationCheckBox.setText(_translate("EmailPage", "Mail server needs authentication"))
