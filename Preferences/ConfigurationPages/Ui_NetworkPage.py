...
# Form implementation generated from reading ui file './Preferences/ConfigurationPages/NetworkPage.ui'
#
...
class Ui_NetworkPage(object):
    def setupUi(self, NetworkPage):
        ...
        NetworkPage.resize(591, 769)
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(NetworkPage)
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(self.proxyGroup)
        ...
        self.httpProxyHostEdit = QtWidgets.QLineEdit(self.groupBox)
        ...
        self.httpProxyPortSpin = QtWidgets.QSpinBox(self.groupBox)
        ...
        self.httpProxyForAllCheckBox = QtWidgets.QCheckBox(self.groupBox)
        self.httpProxyForAllCheckBox.setObjectName("httpProxyForAllCheckBox")
        self.gridLayout_2.addWidget(self.httpProxyForAllCheckBox, 1, 1, 1, 3)
        self.label_4 = QtWidgets.QLabel(self.groupBox)
        self.label_4.setObjectName("label_4")
        self.gridLayout_2.addWidget(self.label_4, 2, 0, 1, 1)
        self.httpsProxyHostEdit = QtWidgets.QLineEdit(self.groupBox)
        self.httpsProxyHostEdit.setObjectName("httpsProxyHostEdit")
        self.gridLayout_2.addWidget(self.httpsProxyHostEdit, 2, 1, 1, 1)
        self.label_5 = QtWidgets.QLabel(self.groupBox)
        self.label_5.setObjectName("label_5")
        self.gridLayout_2.addWidget(self.label_5, 2, 2, 1, 1)
        self.httpsProxyPortSpin = QtWidgets.QSpinBox(self.groupBox)
        ...
        self.gridLayout_2.addWidget(self.httpsProxyPortSpin, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.ftpProxyHostEdit, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.ftpProxyPortSpin, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.ftpProxyTypeCombo, 1, 1, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.groupBox_4, 3, 0, 1, 4)
        ...
        self.verticalLayout.addWidget(self.clearProxyPasswordsButton)
        self.verticalLayout_4.addWidget(self.proxyGroup)
        ...
        self.httpProxyForAllCheckBox.toggled['bool'].connect(self.label_4.setDisabled)
        self.httpProxyForAllCheckBox.toggled['bool'].connect(self.label_3.setDisabled)
        self.httpProxyForAllCheckBox.toggled['bool'].connect(self.httpsProxyHostEdit.setDisabled)
        self.httpProxyForAllCheckBox.toggled['bool'].connect(self.ftpProxyHostEdit.setDisabled)
        self.httpProxyForAllCheckBox.toggled['bool'].connect(self.label_5.setDisabled)
        self.httpProxyForAllCheckBox.toggled['bool'].connect(self.label_7.setDisabled)
        self.httpProxyForAllCheckBox.toggled['bool'].connect(self.httpsProxyPortSpin.setDisabled)
        self.httpProxyForAllCheckBox.toggled['bool'].connect(self.ftpProxyPortSpin.setDisabled)
        ...
        NetworkPage.setTabOrder(self.cleanupSuccessfulButton, self.proxyGroup)
        NetworkPage.setTabOrder(self.proxyGroup, self.systemProxyButton)
        ...
        NetworkPage.setTabOrder(self.httpsProxyPortSpin, self.ftpProxyHostEdit)
        NetworkPage.setTabOrder(self.ftpProxyHostEdit, self.ftpProxyPortSpin)
        NetworkPage.setTabOrder(self.ftpProxyPortSpin, self.ftpProxyTypeCombo)
        NetworkPage.setTabOrder(self.ftpProxyTypeCombo, self.ftpProxyUserEdit)
        ...
        NetworkPage.setTabOrder(self.ftpProxyAccountEdit, self.clearProxyPasswordsButton)
    ...
    def retranslateUi(self, NetworkPage):
        ...
        self.proxyGroup.setTitle(_translate("NetworkPage", "Use network proxy"))
        ...
        self.label.setText(_translate("NetworkPage", "HTTP-Proxy:"))
        ...
        self.label_4.setText(_translate("NetworkPage", "HTTPS-Proxy:"))
