...
# Form implementation generated from reading ui file './Preferences/ConfigurationPages/EditorAutocompletionQScintillaPage.ui'
#
...
class Ui_EditorAutocompletionQScintillaPage(object):
    ...
    def retranslateUi(self, EditorAutocompletionQScintillaPage):
        ...
        self.headerLabel.setText(_translate("EditorAutocompletionQScintillaPage", "<b>Configure QScintilla Autocompletion</b>"))
