...
# Form implementation generated from reading ui file './Preferences/ConfigurationPages/EditorCalltipsPage.ui'
#
...
class Ui_EditorCalltipsPage(object):
    def setupUi(self, EditorCalltipsPage):
        ...
        self.calltipsPositionBox.setEnabled(False)
        ...
        self.ctEnabledCheckBox.toggled['bool'].connect(self.groupBox_4.setEnabled)
        self.ctEnabledCheckBox.toggled['bool'].connect(self.calltipsPositionBox.setEnabled)
        self.ctEnabledCheckBox.toggled['bool'].connect(self.groupBox_2.setEnabled)
        self.ctEnabledCheckBox.toggled['bool'].connect(self.groupBox.setEnabled)
    ...
    def retranslateUi(self, EditorCalltipsPage):
        ...
        self.ctEnabledCheckBox.setText(_translate("EditorCalltipsPage", "Calltips Enabled"))
        ...
        self.ctScintillaCheckBox.setToolTip(_translate("EditorCalltipsPage", "Select to show QScintilla provided calltips, if the selected plugin fails"))
        self.ctScintillaCheckBox.setWhatsThis(_translate("EditorCalltipsPage", "Qscintilla provided calltips are shown, if this option is enabled and calltips shall be provided by a plug-in (see calltips sub-page of the plug-in) and the plugin-in doesn\'t deliver any calltips."))
        self.ctScintillaCheckBox.setText(_translate("EditorCalltipsPage", "Show QScintilla calltips, if plug-in fails"))
