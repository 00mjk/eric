...
# Form implementation generated from reading ui file './Debugger/StartRunDialog.ui'
#
...
class Ui_StartRunDialog(object):
    def setupUi(self, StartRunDialog):
        ...
        StartRunDialog.resize(488, 271)
        StartRunDialog.setSizeGripEnabled(True)
        self.gridLayout = QtWidgets.QGridLayout(StartRunDialog)
        ...
        self.workdirCombo = QtWidgets.QComboBox(StartRunDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.dirButton = QtWidgets.QToolButton(StartRunDialog)
...
"<p>Enter the commandline parameters in this field.</p>"))
        ...
        self.workdirCombo.setToolTip(_translate("StartRunDialog", "Enter the working directory"))
...
"<p>Select to debug the child process after forking. If it is not selected, the parent process will be debugged. This has no effect, if forking without pausing is not selected.</p>"))
        ...
        self.dirButton.setToolTip(_translate("StartRunDialog", "Select directory using a directory selection dialog"))
