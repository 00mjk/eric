...
# Form implementation generated from reading ui file './Debugger/StartProfileDialog.ui'
#
...
class Ui_StartProfileDialog(object):
    def setupUi(self, StartProfileDialog):
        ...
        StartProfileDialog.resize(488, 196)
        StartProfileDialog.setSizeGripEnabled(True)
        self.gridLayout = QtWidgets.QGridLayout(StartProfileDialog)
        ...
        self.workdirCombo = QtWidgets.QComboBox(StartProfileDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.dirButton = QtWidgets.QToolButton(StartProfileDialog)
...
"<p>Enter the commandline parameters in this field.</p>"))
        ...
        self.workdirCombo.setToolTip(_translate("StartProfileDialog", "Enter the working directory"))
...
"<p>Select this to erase the collected timing data before the next profiling run.</p>"))
        ...
        self.dirButton.setToolTip(_translate("StartProfileDialog", "Select directory using a directory selection dialog"))
