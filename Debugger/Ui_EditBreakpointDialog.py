...
# Form implementation generated from reading ui file './Debugger/EditBreakpointDialog.ui'
#
...
class Ui_EditBreakpointDialog(object):
    def setupUi(self, EditBreakpointDialog):
        ...
        EditBreakpointDialog.resize(428, 229)
        ...
        self.filenameCombo = QtWidgets.QComboBox(EditBreakpointDialog)
        self.filenameCombo.setEditable(True)
        self.filenameCombo.setObjectName("filenameCombo")
        ...
        self.fileButton = QtWidgets.QToolButton(EditBreakpointDialog)
    ...
    def retranslateUi(self, EditBreakpointDialog):
        ...
        self.filenameCombo.setToolTip(_translate("EditBreakpointDialog", "Enter the filename of the breakpoint"))
        ...
        self.fileButton.setToolTip(_translate("EditBreakpointDialog", "Press to open a file selection dialog"))
