...
# Form implementation generated from reading ui file './Debugger/StartDebugDialog.ui'
#
...
class Ui_StartDebugDialog(object):
    def setupUi(self, StartDebugDialog):
        ...
        StartDebugDialog.resize(488, 300)
        StartDebugDialog.setSizeGripEnabled(True)
        self.gridLayout = QtWidgets.QGridLayout(StartDebugDialog)
        ...
        self.workdirCombo = QtWidgets.QComboBox(StartDebugDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.dirButton = QtWidgets.QToolButton(StartDebugDialog)
...
"<p>Enter the commandline parameters in this field.</p>"))
        ...
        self.workdirCombo.setToolTip(_translate("StartDebugDialog", "Enter the working directory"))
...
"<p>Select to debug the child process after forking. If it is not selected, the parent process will be debugged. This has no effect, if forking without pausing is not selected.</p>"))
        ...
        self.dirButton.setToolTip(_translate("StartDebugDialog", "Select directory using a directory selection dialog"))
